...
import type { AppRole as _AppRole, ExternalBlob as _ExternalBlob, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async acceptProposal(arg0: JobId, arg1: UserId): Promise<Proposal> {
        if (this.processError) {
            try {
                const result = await this.actor.acceptProposal(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async chooseRole(arg0: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.chooseRole(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createJob(arg0: string, arg1: string, arg2: bigint, arg3: Category): Promise<JobId> {
        if (this.processError) {
            try {
    ...
    async downloadResume(arg0: UserId): Promise<ExternalBlob | null> {
        if (this.processError) {
            try {
                const result = await this.actor.downloadResume(arg0);
    ...
    async getAllOpenJobs(): Promise<Array<Job>> {
        if (this.processError) {
            try {
    ...
    async getJobsByCustomer(arg0: UserId): Promise<Array<Job>> {
        if (this.processError) {
            try {
    ...
    async getMyProposals(): Promise<Array<Proposal>> {
        if (this.processError) {
            try {
                const result = await this.actor.getMyProposals();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getOpenJobsByCategory(arg0: Category): Promise<Array<Job>> {
        if (this.processError) {
            try {
                const result = await this.actor.getOpenJobsByCategory(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getProposalsForJob(arg0: JobId): Promise<Array<Proposal>> {
        if (this.processError) {
            try {
                const result = await this.actor.getProposalsForJob(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getPublicProfile(arg0: UserId): Promise<UserProfile | null> {
        if (this.processError) {
            try {
    ...
    async submitProposal(arg0: JobId, arg1: string, arg2: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateMyProfile(arg0: string, arg1: string, arg2: Array<string>, arg3: bigint, arg4: ExternalBlob | null): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateMyProfile(arg0, arg1, arg2, arg3, await to_candid_opt_n24(this._uploadFile, this._downloadFile, arg4));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_record_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        bio: value.bio,
        resume: record_opt_to_undefined(await from_candid_opt_n10(_uploadFile, _downloadFile, value.resume)),
...
function from_candid_variant_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "customer" in value ? AppRole.customer : "freelancer" in value ? AppRole.freelancer : value;
}
...
async function to_candid_record_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        bio: value.bio,
        resume: value.resume ? candid_some(await to_candid_ExternalBlob_n21(_uploadFile, _downloadFile, value.resume)) : candid_none(),
        displayName: value.displayName,
        appRole: to_candid_AppRole_n22(_uploadFile, _downloadFile, value.appRole),
        hourlyRate: value.hourlyRate,
        skills: value.skills
    };
}
